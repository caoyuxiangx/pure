package io.manager.bangche.agency.utils.logger;
...
import io.manager.bangche.agency.utils.logger.util.ArrayUtil;
import io.manager.bangche.agency.utils.logger.util.SystemUtil;
 ...
 * @author Orhan Obut
 */
final class LoggerPrinter implements io.manager.bangche.agency.utils.logger.Printer {
   ...
   */
  private static final io.manager.bangche.agency.utils.logger.Settings settings = new io.manager.bangche.agency.utils.logger.Settings();
   ...
   */
  @Override
  public io.manager.bangche.agency.utils.logger.Settings init(String tag) {
    if (tag == null) {
  ...
  @Override
  public io.manager.bangche.agency.utils.logger.Settings getSettings() {
    return settings;
  }
